...
Let the vectors $f_i \in A$ generate an ideal $I \subset A$.  We will now show that $A/I$ is a complete intersection.  For this, we require some preparatory computations.
...
\end{lemma}
\begin{proof} We begin by showing that 
\[
...
We are now ready to show that $A/I$ is a complete intersection.
