...
\end{align*}
where in the second step we have subtracted $n zc F_1(z)$.  We note that $[z^p]\left(\frac{G(z)+z^2V(z)}{1-x_1z}\right)$ is a linear combination of $[z^l](G(z)+z^2V(z))$ for $0 \le l \le p$, hence a linear combination of $[z^l]G(z)$ for $0 \le l \le p$ and $[z^l]V(z)$ for $0 \le l \le p-2$. By Lemmas~\ref{lem:dFdz} and \ref{lem:dFdxi}, these coefficients of $G(z)$ and $V(z)$ are all $0$, hence $[z^p]\left(\frac{G(z)+z^2V(z)}{1-x_1z}\right)=0$. We conclude that 
\[
