...
\begin{document}
 ...
 \author{Sheela Devadas\thanks{Math Dept., MIT, Cambridge MA 02139
 E-mail: {\tt sheelad@mit.edu}. Phone: {\tt 781-325-6895}}\;and Yi Sun\thanks{Math Dept., MIT, Cambridge MA 02139
 E-mail: {\tt yisun@math.mit.edu}.
 Research supported by NSF Grant \#1122374. \\\\ Both authors were also supported by NSF Grant DMS-1000113.
}}
 \title{The polynomial representation of the type $A_{n - 1}$ rational Cherednik algebra in characteristic $p \mid n$}
\date{May 28, 2015}
\journalname{Algebras and Representation Theory}
\institute{}
...
\keywords{modular representation theory \and rational Cherednik algebras} 
\subclass{16G99 \and 20C20}
\end{abstract}
...
\[
D_{y_2 - y_1} f_1 = [z^p]D_{y_2-y_1}(F_1(z))= [z^p]\left(-zF_1(z)-z^2\frac{\partial F_1}{\partial z}\right) = -b + b = 0. \qed
\]
\end{proof}
